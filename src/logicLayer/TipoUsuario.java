...
public enum TipoUsuario {
	...
	Cliente(new String[]{"Depositar dinero","Transferir", "Retirar dinero", "Solicitar prestamo", "Pagar servicios","Cambiar dolares", "Ver saldo", "Ver movimientos","Ver informacion", "salir"}),
